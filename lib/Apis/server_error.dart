    ...
    switch (error.type) {
      case DioErrorType.connectTimeout:
        ...
        Fluttertoast.showToast(
            msg: 'Connection timeout', toastLength: Toast.LENGTH_SHORT, gravity: ToastGravity.BOTTOM);
        break;
      case DioErrorType.sendTimeout:
        _errorMessage = "Receive timeout in send request";

        Fluttertoast.showToast(
            msg: 'Receive timeout in send request', toastLength: Toast.LENGTH_SHORT, gravity: ToastGravity.BOTTOM);
        break;
      case DioErrorType.receiveTimeout:
        _errorMessage = "Receive timeout in connection";

        Fluttertoast.showToast(
            msg: 'Receive timeout in connection', toastLength: Toast.LENGTH_SHORT, gravity: ToastGravity.BOTTOM);
        break;
      case DioErrorType.response:
        ...
        try {
          if (error.response!.data['errors']['name'] != null) {
            ...
            Fluttertoast.showToast(
                msg: '${error.response!.data['errors']['confirm_password'][0]}',
                toastLength: Toast.LENGTH_SHORT,
                gravity: ToastGravity.BOTTOM);
            return;
            ...
            Fluttertoast.showToast(
                msg: '${error.response!.data['errors']['otp'][0]}',
                toastLength: Toast.LENGTH_SHORT,
                gravity: ToastGravity.BOTTOM);
            return;
            ...
            Fluttertoast.showToast(
                msg: '${error.response!.data['errors']['label'][0]}',
                toastLength: Toast.LENGTH_SHORT,
                gravity: ToastGravity.BOTTOM);
            return;
          } else if (error.response!.data['errors']['addr1'] != null) {
            Fluttertoast.showToast(
                msg: '${error.response!.data['errors']['addr1'][0]}',
                toastLength: Toast.LENGTH_SHORT,
                gravity: ToastGravity.BOTTOM);
            return;
          } else if (error.response!.data['errors']['rate'] != null) {
            Fluttertoast.showToast(
                msg: '${error.response!.data['errors']['rate'][0]}',
                toastLength: Toast.LENGTH_SHORT,
                gravity: ToastGravity.BOTTOM);
            return;
          } else if (error.response!.data['errors']['msg'] != null) {
            Fluttertoast.showToast(
                msg: '${error.response!.data['errors']['msg'][0]}',
                toastLength: Toast.LENGTH_SHORT,
                gravity: ToastGravity.BOTTOM);
            return;
          } else if (error.response!.data['errors']['img'] != null) {
            Fluttertoast.showToast(
                msg: '${error.response!.data['errors']['img'][0]}',
                toastLength: Toast.LENGTH_SHORT,
                gravity: ToastGravity.BOTTOM);
            return;
          } else if (error.response!.data != null) {
            Fluttertoast.showToast(
                msg: '${error.response!.data}', toastLength: Toast.LENGTH_SHORT, gravity: ToastGravity.BOTTOM);
            return;
          } else {
            Fluttertoast.showToast(
          ...
          Fluttertoast.showToast(
              msg: 'Exception occurred', toastLength: Toast.LENGTH_SHORT, gravity: ToastGravity.BOTTOM);
      ...
      case DioErrorType.cancel:
        ...
        Fluttertoast.showToast(
            msg: 'Request was cancelled', toastLength: Toast.LENGTH_SHORT, gravity: ToastGravity.BOTTOM);
        break;
