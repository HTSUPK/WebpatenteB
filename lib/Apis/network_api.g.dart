...
class _RestClient implements RestClient {
  ...
  Future<AuthModel> registerRequest(body) async {
    ...
    final _data = body;
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<AuthModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<VersionCheckModel> versionCheckRequest(body) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = body;
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<VersionCheckModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<QuestionModel> questionRequest(body) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = body;
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<QuestionModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ChapterListModel> chapterListRequest() async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<ChapterListModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<QuizModel> selectQuizRequest(body) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = body;
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<QuizModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<QuizResultModel> quizResultRequest(body) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = body;
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<QuizResultModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<StatisticsModel> statisticsRequest() async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<StatisticsModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
